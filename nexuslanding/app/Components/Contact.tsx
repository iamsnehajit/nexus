...
export default function Contact() {
  ...
  return (
    // জটলা বা ট্রিপল ক্লোজিং ডিফ ফিক্স করে ক্লিন করা হয়েছে
    <div ref={containerRef} className="w-full min-h-screen bg-[#f1f1f1] flex items-center justify-center overflow-hidden">
      <div className="container-custom py-20 w-full">
        <div className="grid grid-cols-12 gap-8 items-center">
          
          {/* 📸 বাম পাশের ইমেজ এরিয়া */}
          <div className="col-span-12 lg:col-span-6">
            {/* কন্টেইনারটিকে রিলেটিভ এবং ওভারফ্লো হিডেন করা হয়েছে যাতে পেছনের ইমেজটি নিচ থেকে ওপরে ওঠার সময় বাইরে না দেখা যায় */}
            <div className="contact-left relative rounded-4xl overflow-hidden h-[450px] md:h-[550px] w-full">
              ...
              <Image 
                ...
                className="w-[70%] rounded-4xl left-1/2 -translate-x-1/2 bottom-0 absolute"
                priority
              />
