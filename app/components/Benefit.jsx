                    ...
                    <div className='relative overflow-hidden bg-[#d5f7e9] border border-[#BEEEDB] rounded-xl p-4 h-32'>
                        <div className='grid grid-cols-12 h-full'>
                            ...
                            <div className='col-span-8 flex justify-center items-start h-full'>
                                <div>
                                    <h2 className="poppin font-medium mb-2 text-[18px] md:text-xl dark leading-[1.2]">100% Safe & Secure</h2>
                ...
                <div className='col-span-12 md:col-span-6 lg:col-span-3'>
                    <div className='relative overflow-hidden bg-[#d5f7e9] border border-[#BEEEDB] rounded-xl p-4 h-32'>
                        <div className='grid grid-cols-12 h-full'>
                            ...
                            <div className='col-span-8 flex justify-center items-start h-full'>
                                <div>
                                    <h2 className="poppin font-medium mb-2 text-[18px] md:text-xl dark leading-[1.2]">Click and Pick</h2>
                ...
                <div className='col-span-12 md:col-span-6 lg:col-span-3'>
                    <div className='relative overflow-hidden bg-[#d5f7e9] border border-[#BEEEDB] rounded-xl p-4 h-32'>
                        <div className='grid grid-cols-12 h-full'>
                            ...
                            <div className='col-span-8 flex justify-center items-start h-full'>
                                <div>
                                    <h2 className="poppin font-medium mb-2 text-[18px] md:text-xl dark leading-[1.2]">Home Delivery</h2>
                ...
                <div className='col-span-12 md:col-span-6 lg:col-span-3'>
                    <div className='relative overflow-hidden bg-[#d5f7e9] border border-[#BEEEDB] rounded-xl p-4 h-32'>
                        <div className='grid grid-cols-12 h-full'>
                            ...
                            <div className='col-span-8 flex justify-center items-start h-full'>
                                <div>
                                    <h2 className="poppin font-medium mb-2 text-[18px] md:text-xl dark leading-[1.2]">Unlimited Health Records</h2>
            ...
            <div className="border-t border-[#D8D6D6] mt-12 pt-8">
                <ul>
                    <li className="poppin gray2 leading-[1.3] mb-5 text-sm">
                        <span className="dark text-[16px] md:text-xl poppin font-medium leading-[1.3] ">Top-Selling Medicines:</span> Montair LC | Telma 40 | Wegovy 0.25mg | Mounjaro 2.5mg | Rybelsus 7mg | Mounjaro 7.5mg | Pantocid DSR | Erly 6mg | Nurokind LC | Yurpeak 5mg | Megalis 10 | Lirafit 6mg | Yurpeak 10mg | Amoxyclav 625 | Wegovy 0.5mg | Levipil 500
                    </li>
                    <li className="poppin gray2 leading-[1.3] mb-5 text-sm">
                        <span className="dark text-[16px] md:text-xl poppin font-medium leading-[1.3] ">Top-Tests we cover:</span> Thyroid Profile Test | Prolactin Test | D Dimer Test | FBS Test | ESR Test | CBC Test | HbA1c Test | VDRL Test | RBS Test | SGPT Test | Creatinine Test | HIV Test | Troponin Test | CRP Test | Liver Function Test | Lipid Profile Test | PSA Test
                    </li>
                    <li className="poppin gray2 leading-[1.3] mb-5 text-sm">
