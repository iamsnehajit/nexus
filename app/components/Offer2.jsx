...
export default function BlueBannerSlider() {
  const banners = [
    ...
    { id: 3, title: "GET 20% OFF", subtitle: "on your first consult", text: "Expert doctors available 24/7" },
  ];

  return (
    // 'blue-banner-scope' ক্লাসটি ব্যবহার করা হয়েছে যেন অন্য স্লাইডারের ডিজাইন না ভাঙে
    <div className="blue-banner-scope w-full">
      <h2 className='dark text-[20px] md:text-[25px] font-medium pt-10 pb-7 text-center'>Book Lab Test Online with Nexus</h2>
